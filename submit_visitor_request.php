...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO visitor_requests (st_id, visitor_name, visitation_date, visitation_purpose)
            VALUES ('$student_id', '$visitor_name', '$visitation_date', '$visitation_purpose')";
