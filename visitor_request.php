...
<body>
    <div class="container mt-5">
        ...
        <form action="submit_visitor_request.php" method="POST"> <!--  Important: Create submit_visitor_request.php -->
            <div class="mb-3">
                <label for="student_id" class="form-label">Student ID:</label>
                <input type="text" class="form-control" id="student_id" name="student_id" value="<?php echo isset($_SESSION['student_id']) ? $_SESSION['student_id'] : ''; ?>" readonly>
            </div>
            <div class="mb-3">
